					<footer id="footer">
						...
						<ul class="copyright">
							<li> <a href="../admin/admin_login.php">admin</a></li> <br>
							<li><a href="#" target="_blank" class="icon solid fa-envelope"><span class="label">Email</span></a></li>
							<li>kontakt: irongym@gmail.com</li> <br>
